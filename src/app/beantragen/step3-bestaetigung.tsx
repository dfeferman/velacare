  ...
  return (
    <div className="animate-fade-up">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {/* Produkte */}
        <section className="bg-v3-surface rounded-xl p-6 mb-4 border border-v3-outline/25" aria-label="Ihre Produktauswahl">
        ...
        {/* Angaben */}
        <section className="bg-v3-surface rounded-xl p-6 mb-4 border border-v3-outline/25" aria-label="Ihre persönlichen Angaben">
          <h2 className="font-newsreader text-lg text-v3-on-surface mb-3 flex items-center gap-2">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
        ...
        {/* Liefertag */}
        <section className="bg-v3-surface rounded-xl p-6 mb-4 border border-v3-outline/25" aria-label="Liefertag wählen">
